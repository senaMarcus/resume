    ...
    return(
        <div className="a">
            ...
            <div className="a-right">
                ...
                <p className="a-desc">
                    Me chamo Marcus, como já devem ter percebido, tenho 27 anos, nascido numa cidade do interior de Minas Gerais/Brasil chamada Nanuque. Costumo dizer que a paixao pela tecnologia esta no meu sangue. Por algum motivo, durante minha juventude, acabei desviando meu foco da tecnologia para outras áreas, mas de 2020 até os dias de hoje tenho me aprofundado bastante nesse universo. <br/> <br/>
